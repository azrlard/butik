...
<div class="min-h-screen bg-gradient-to-br from-[#F5F5DC]/30 via-white to-[#F5F5DC]/50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        <div class="text-center">
            <h2 class="mt-6 text-3xl font-extrabold text-[#3E2723]">Buat Akun Baru</h2>
            <p class="mt-2 text-sm text-[#3E2723] opacity-80">
                Atau
                <a href="/login" class="font-medium text-[#8B4513] hover:text-[#D2691E]">
                    masuk ke akun Anda
                </a>
            </p>
        </div>
        ...
        <div class="bg-white py-8 px-6 shadow-xl rounded-2xl border border-[#F5F5DC]">
            <form id="register-form" class="space-y-6" method="POST" action="/register">
                @csrf
                <div>
                    <label for="name" class="block text-sm font-medium text-[#3E2723]">Nama Lengkap</label>
                    <div class="mt-1">
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-[#3E2723]">Konfirmasi Password</label>
                    <div class="mt-1">
