    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-8">
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-6">
                <div class="flex-1">
                    <h2 class="text-xl font-bold text-gray-900 mb-1">Filter & Cari Produk</h2>
                    <p class="text-sm text-gray-600">Temukan produk yang sesuai dengan preferensi Anda</p>
                </div>
            </div>
            ...
            <form method="GET" action="{{ route('products.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <button type="submit" 
                                class="px-4 py-2 bg-indigo-600 text-white rounded-lg font-medium hover:bg-indigo-700 transition-colors whitespace-nowrap">
                            Cari
                        </button>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            @forelse($products as $product)
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 group overflow-hidden border border-gray-100">
                    <!-- Product Image -->
                    ...
                    <div class="p-4">
                        <div class="flex items-start justify-between mb-2">
                            ...
                            <span class="bg-indigo-100 text-indigo-700 text-xs px-2 py-1 rounded-full font-medium flex-shrink-0">
                        ...
                        <a href="{{ route('products.detail', $product->id) }}" 
                           class="block w-full bg-indigo-600 text-white py-2 px-4 rounded-lg text-sm font-medium hover:bg-indigo-700 transition-colors text-center">
                            Lihat Detail
                        </a>
                    </div>
                </div>
            @empty
                <div class="col-span-full text-center py-12">
                    <div class="max-w-md mx-auto">
                        ...
                        <p class="text-gray-600 text-sm">Coba ubah filter pencarian Anda</p>
                    </div>
                </div>
            @endforelse
        </div>
