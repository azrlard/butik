...
<section class="relative text-text py-20 lg:py-28 overflow-hidden min-h-screen">
    ...
    <!-- Floating Elements -->
    <div class="absolute top-20 left-10 w-20 h-20 bg-primary/20 rounded-full blur-xl animate-pulse z-10"></div>
    <div class="absolute bottom-20 right-10 w-32 h-32 bg-secondary/30 rounded-full blur-xl animate-pulse delay-1000 z-10"></div>
    <div class="absolute top-1/2 left-1/4 w-16 h-16 bg-highlight/25 rounded-full blur-xl animate-pulse delay-500 z-10"></div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-20">
        ...
        <div class="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button onclick="window.location.href='/products'" class="group bg-primary text-white px-10 py-5 rounded-2xl text-xl font-bold hover:bg-primary/90 transition-all duration-300 transform hover:scale-105 shadow-2xl shadow-primary/25 hover:shadow-primary/40">
