...
<div id="settings">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-8">
            <h1 class="text-4xl md:text-5xl font-black text-text mb-4">Pengaturan Akun</h1>
            <p class="text-xl text-text">Kelola preferensi dan keamanan akun Anda</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-background rounded-2xl shadow-lg border border-secondary p-6">
                    <div class="space-y-3">
                        ...
                        <a href="/settings" class="flex items-center px-4 py-3 bg-secondary text-background rounded-xl font-semibold">
                            ⚙️ Pengaturan
                        </a>
                    </div>
                </div>
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-background rounded-2xl shadow-lg border border-secondary p-8">
                    <div class="mb-6">
                        <h2 class="text-2xl font-bold text-text mb-2">Keamanan Akun</h2>
                        <p class="text-text">Kelola kata sandi dan keamanan akun Anda</p>
                    </div>

                    <form id="password-form" onsubmit="updatePassword(event)" class="space-y-6">
                        <div>
                            <label for="current_password" class="block text-sm font-semibold text-text mb-2">Kata Sandi Saat Ini</label>
